...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 align="center">
        <i class="fa fa-cab"></i> Car Gallery
        <small></small>
      </h1>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-car"></i> Car Gallery Data Table</h3><button type="button" class="btn btn-success btn-sm" style="margin-left: 2%" data-toggle="modal" data-target="#add">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr style="background-color: #c5c5c5;">
                  ...
                  <th style="width: "><i class="fa fa-car"></i> Model</th>
                  <th style="width: "><i class="fa fa-paint-brush"></i> Color</th>
                  <th style="width: 11.8%"> </th>
                </tr>
                </thead>
                <tbody>
                <tr>
                  <td><img src="dist/img/photo1.png" class="img-square" alt="User Image" style="width: 100%"></td>
                  <td>Data</td>
                  <td>Data</td>
                  <td>Data</td>
                  <td align="center"><span class="btn btn-success btn-xs">Green</span></td>
                ...
                <tr>
                  <td><img src="dist/img/photo4.jpg" class="img-square" alt="User Image" style="width: 100%"></td>
                  <td>Data</td>
                  <td>Data</td>
                  <td>Data</td>
                  <td align="center"><span class="btn btn-danger btn-xs">Red</span></td>
                  <td align="center"><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit"><i class="fa fa-pencil"></i></button> <button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button> <button type="button" style="background-color: #c3039e;" class="btn btn-sm"><i class="fa fa-eye" style="color: white"></i></button></td>
                </tr>
                </tbody>
                <tfoot>
