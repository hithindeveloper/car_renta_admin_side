            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr style="background-color: #c5c5c5;">
                  ...
                  <th><i class="fa fa-user"></i> Car Owner</th>
                  <th><i class="fa fa-cab"></i> Car</th>
                ...
                <tr>
                  ...
                  <td>Lamburgeny</td>
                  <td>Zebbiana</td>
                  <td align="center"><span class="btn btn-success btn-xs">Paid</span></td>
                ...
                <tr>
                  ...
                  <td>Lamburgeny</td>
                  <td>Zebbiana</td>
                  <td align="center"><span class="btn btn-danger btn-xs">Not Paid</span></td>
                  <td align="center"><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit"><i class="fa fa-pencil"></i></button> <button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></td>
                </tr>
                </tbody>
                <tfoot>
